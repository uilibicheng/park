<template>
  <div class="page" v-if="!isLoading">
    <div class="content" :class="{'filter' : isShowDialog}">
      ...
      <div class="page-title">支付出场</div>

      <div class="info-box">
        <div class="info-box-title">优惠出场信息</div>
        <div class="info-list">
          <div class="info-item">
          ...
          <div class="info-item">
            <div class="info-item-label">优惠抵扣：</div>
            <div class="info-item-value">￥{{parkInfo.discountFee}}</div>
          </div>
        </div>
        <div class="info-item infp-active-item">
          <div class="info-item-label">应付：</div>
          <div class="info-item-value">￥{{parkInfo.totalFee}}</div>
        </div>
      </div>


      <div class="button" @click="confirm">前往支付</div>
